...
class item_m extends CI_Model{
    ...
    function tampilcategorydanunit() 
    {
        $this->db->order_by('item_id', 'ASC');
        return $this->db->from('p_item')
          ->join('p_category', 'p_category.name=p_item.cateory_id')
          ->get()
          ->result();
        
        $this->db->order_by('item_id', 'ASC');
        return $this->db->form('p_item')
            ->join('p_unit', 'p_unit.name=p_item.unit_id')
            ->get()
            ->result();
    }  
