...
class User extends CI_Controller {
	...
	public function add()
	{
		$this->form_validation->set_rules('fullnama', 'Name', 'required|min_length[5]');
		...
		$this->form_validation->set_message('min_length', '%s minimal 5 caracter !');
		$this->form_validation->set_message('is_unique', '%s Sudah digunakan, silahkan ganti username anda !');
