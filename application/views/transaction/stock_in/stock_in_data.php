                    ...
                    <?php $no = 1;
                        ...
                        <tr>
                            ...
                            <td class="text-center" width="160px">
                                <a id="stock_detail" class="btn btn-default btn-xs" data-toggle="modal" data-target="#modal-detail"
                                ...
                                <a href="<?=site_url('stock/in/del/'.$data->stock_id.'/'.$data->item_id)?>" name="stock_id" class="btn btn-danger btn-xs" onclick="return confirm('Apakah anda yakin ?')">
